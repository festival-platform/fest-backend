    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dates', django.contrib.postgres.fields.ArrayField(base_field=models.DateField(), blank=True, default=list, help_text='Список доступных дат для бронирования.', size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stars', models.PositiveIntegerField(validators=[events.models.validate_stars])),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('booked_dates', django.contrib.postgres.fields.ArrayField(base_field=models.DateField(), blank=True, default=list, help_text='Список дат, на которые пользователь уже записан.', size=None)),
